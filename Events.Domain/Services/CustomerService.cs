...
namespace Events.Domain.Services
{
    public class CustomerService: ICustomerService
    {
        ...
        public List<EmailCampaign> SortEventByLowerPrice(string eventCity, string customerCity)
        {
            try
            {
                List<EmailCampaign> emailCampaigns = new List<EmailCampaign>();
                ...
                emailCampaigns[0].Events = eventCampaigns.OrderBy(e=>e.Price).Take(5).ToList();
                emailCampaigns[0].Response = new Response.Response
                {
                    Code = ResponseMapping.Success00Code,
                    Message = ResponseMapping.Success00Message
        ...
        public List<EmailCampaign> SortEventByHigherPrice(string eventCity, string customerCity)
        {
            try
            {
                List<EmailCampaign> emailCampaigns = new List<EmailCampaign>();
                ...
                emailCampaigns[0].Events = eventCampaigns.OrderByDescending(e => e.Price).Take(5).ToList();
                emailCampaigns[0].Response = new Response.Response
                {
                    Code = ResponseMapping.Success00Code,
                    Message = ResponseMapping.Success00Message
